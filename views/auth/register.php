<?php
/**
 * Register View - Interactive & Engaging Design
 */
  ...
  <div class="login-container">
    <div class="login-card">
      ...
      <div class="login-header">
        ...
        <p class="login-subtitle">Join us and explore premium spices</p>
      </div>
      ...
      <form method="POST" action="<?= url('register') ?>" class="login-form" id="registerForm">
        ...
        <p class="login-footer">
          ...
          <a href="<?= url('login') ?>" class="register-link">Sign in here</a>
        </p>
      </form>
    </div>
...
@keyframes pulse {
  0%, 100% { transform: scale(1); box-shadow: 0 6px 20px rgba(50, 198, 141, 0.3); }
  50% { transform: scale(1.05); box-shadow: 0 10px 28px rgba(50, 198, 141, 0.4); }
}
